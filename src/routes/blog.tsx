        ...
        <div className="min-h-screen pt-24 px-4 pb-16">
            <div className="max-w-4xl mx-auto">
                ...
                <div className="mb-12">
                    <Link
                        to="/"
                        className="inline-flex items-center gap-2 text-zinc-400 hover:text-cyan-500 transition-colors group mb-8"
                    >
                        <ArrowLeft
                            size={20}
                    ...
                    <h1 className="text-5xl md:text-7xl font-black tracking-tighter text-white mb-4">
                        THOUGHT<span className="text-cyan-500">LOGS</span>_
                    </h1>
                        ...
                        >
                            <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
                                <div className="flex-1">
                                    <div className="flex flex-wrap items-center gap-4 text-zinc-500 text-sm mb-3">
                                    ...
                                    <h2 className="text-2xl font-bold text-white group-hover:text-cyan-500 transition-colors mb-2">
                                        {post.title}
                                    </h2>
                                ...
                                <ArrowRight
                                    size={24}
                                    className="text-zinc-600 group-hover:text-cyan-500 group-hover:translate-x-2 transition-all flex-shrink-0 mt-2 md:mt-0"
                                />
                            </div>
                        </Link>
                    ))}
