...
import { getBlogPost, getAdjacentPosts } from "../content/blog/posts";
        ...
        return (
            <div className="min-h-screen pt-24 px-4 pb-16 flex items-center justify-center">
                <div className="text-center">
                    <h1 className="text-4xl font-black text-zinc-200 mb-4">
                        404
                    </h1>
        ...
        <div className="min-h-screen pt-24 px-4 pb-16">
            <div className="max-w-3xl mx-auto">
                ...
                <header className="mb-12 border-b border-zinc-800 pb-8">
                    ...
                    <h1 className="text-4xl md:text-6xl font-black tracking-tight text-zinc-200 mb-4">
                        {post.title}
                    </h1>

                    {post.series && post.seriesPart && (
                        <p className="text-cyan-500 font-mono text-sm mb-2">
                            Part {post.seriesPart} of {post.series}
                        </p>
                    )}
                ...
                <article
                    className="prose prose-invert prose-zinc max-w-none
                                    prose-headings:font-black prose-headings:tracking-tight prose-headings:text-zinc-200
                                    prose-h1:text-4xl prose-h1:mb-8 prose-h1:mt-12
                                    prose-h2:text-2xl prose-h2:mt-10 prose-h2:mb-4 prose-h2:text-cyan-500
                                    ...
                                    prose-code:text-cyan-500 prose-code:bg-zinc-900 prose-code:px-1.5 prose-code:py-0.5 prose-code:rounded prose-code:before:content-none prose-code:after:content-none
                    ...
                    <div className="flex flex-col sm:flex-row gap-4 sm:justify-between">
                        {prev ? (
                            <Link
                                ...
                                className="group flex-1 p-4 bg-zinc-900/50 border border-zinc-800 rounded-lg hover:border-cyan-500/50 transition-colors"
                            >
                                <span className="text-zinc-500 text-sm flex items-center gap-1 mb-1">
                                    <ArrowLeft size={14} /> Previous
                                </span>
                                <span className="text-zinc-200 font-medium group-hover:text-cyan-500 transition-colors">
                                    {prev.title}
                                </span>
                            </Link>
                        ) : (
                        ...
                        {next ? (
                            <Link
                                ...
                                className="group flex-1 p-4 bg-zinc-900/50 border border-zinc-800 rounded-lg hover:border-cyan-500/50 transition-colors text-right"
                            >
                                <span className="text-zinc-500 text-sm flex items-center justify-end gap-1 mb-1">
